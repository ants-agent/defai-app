...
const features = [
  ...
  */
  ...
  },
  {
    ...
    name: 'Open Source',
    description:
      'Our full-stack application is open source and community-driven, fostering transparency and collaboration. We invite developers globally to contribute and help shape the future of Blockchain AI tools.',
    className: 'col-span-1 sm:col-span-3 lg:col-span-1',
    background: (
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
  ...
  {
    Icon: School,
    name: 'Foundation Research-Grounded',
    description:
...
const Features = () => {
  return (
    ...
    <h2 className="mb-3 text-2xl font-bold tracking-tight sm:mb-4 sm:text-4xl text-center">
    Scalable and Interoperable AI Agent on Blockchain
          </h2>
                <IntegrationsGrid />
